...
import { Search, Video, Wrench, FlaskConical, BookOpen, Book, ArrowRight, Clock, Sparkles, Star, CheckCircle, Rocket } from 'lucide-react';
...
export default function CuriosityCentre({ totalXP = 1250 }) {
  ...
  return (
    <div className="flex flex-col h-full bg-[hsl(var(--main-bg))] overflow-y-auto">
      ...
      {/* Floating Homie Mascot - Bottom Right Corner - Smaller Size */}
      <div 
        className="fixed bottom-8 right-8 z-20 cursor-pointer"
        onClick={() => {
          // TODO: Open Homie chat or navigate to chat page
